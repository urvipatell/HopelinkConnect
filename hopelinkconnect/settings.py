"""
Django settings for hopelinkconnect project.
...
SECRET_KEY = 'django-insecure-u4(iyjvbe=lh_6k6^y_d-lh5$_u1$s*xp^yk&o&ab#_&7j9p!g'
...
ROOT_URLCONF = 'hopelinkconnect.urls'
...
WSGI_APPLICATION = 'hopelinkconnect.wsgi.application'
...
# Define the root directory where collected static files will be stored
STATIC_ROOT = os.path.join(BASE_DIR, 'static')

# Define additional directories where static files are located
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'hopelinkconnect/static'),
